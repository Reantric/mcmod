package com.protonlaser.tutorialmod;
...
public class TutorialMod
{
 ...
 /*   private void enqueueIMC(final InterModEnqueueEvent event)
    ...
    public static class TutorialItemGroup extends ItemGroup {
        public static final TutorialItemGroup instance = new TutorialItemGroup(ItemGroup.GROUPS.length,"bruhbandy");
        ...
        public ItemStack createIcon(){
            return new ItemStack(BlockInit.bendite_block); // Texture of icon
        }
    }
